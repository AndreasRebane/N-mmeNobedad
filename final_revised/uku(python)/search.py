...
ehitusteaduskonnalaborihoone = placeInfo(773, 181, ["laboratory builsing of civil engineering", "con"], "ehitusteaduskonna laborihoone", [""])
itkolledz = placeInfo(676, 343, ["it college", "ico"], "it kolledž", [""])
tehnoloogiapark = placeInfo(880, 290, ["technology park", "itc"], "tehnoloogiapark", [""])
kuberneetikamaja = placeInfo(846, 401, ["building of cybernetics", "cyb"], "küberneetikamaja", ["ttü küberneetika instituut", "institute of cybernetics at tut", "ttü meresüsteemida instituut", "institute of marine systems at tut"])
puidumaja = placeInfo(982, 298, ["building of woodworking", "tim"], "puidumaja", ["puidutöötlemise õppetool", "chair of woodworking"])
staadion = placeInfo(572, 291, ["stadium", "sta"], "staadion", [""])
tekstiilimaja = placeInfo(217, 559, ["textile technology building", "tex"], "tekstiilimaja", ["disaini lektoraat", "chair of design", "tekstiilitehnoloogia õppetool", "chair of textile technology"])
spordikeskus = placeInfo(274, 603, ["sports center", "so1"], "spordikeskus", [""])
oppehoone10 = placeInfo(608, 544, ["study buoilding 10", "uo7"], "õppehoone 10", ["majandusteaduskond", "tallinn school of economics and bussiness administration", "sotsiaalteaduskond", "faculty of social sciences", "ttü majandusteaduskonna koolituskeskus", "center for economic education of faculty of economics and bussiness administration at tut", "keeltekeskus", "language center", "söökla", "cafeteria", "postkontor ja meened", "post office and souvenirs", "swedbanki kontor", "swedbank branch", "lillepood", "florist"])
